...
// NewGetContainerObjectParams creates a new GetContainerObjectParams object
//
// There are no default values defined in the spec.
func NewGetContainerObjectParams() GetContainerObjectParams {

	return GetContainerObjectParams{}
}

// GetContainerObjectParams contains all the bound params for the get container object operation
// typically these are obtained from a http.Request
//
// swagger:parameters getContainerObject
...
//
// To ensure default values, the struct must have been initialized with NewGetContainerObjectParams() beforehand.
func (o *GetContainerObjectParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetContainerObjectParams) bindContainerID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetContainerObjectParams) bindDownload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetContainerObjectParams) bindObjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
